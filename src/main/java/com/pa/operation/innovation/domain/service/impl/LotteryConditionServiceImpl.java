...
@Service
public class LotteryConditionServiceImpl implements LotteryConditionService {
    @Override
    public LotteryConditionResult checkLotteryCondition(int lotteryId, String userId) {
        return null;
    }
}
